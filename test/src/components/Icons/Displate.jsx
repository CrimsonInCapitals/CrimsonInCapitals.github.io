...
export const Displate =({width='2em', className='vector_button',onClick})=>{
    ...
    return(
        ...
        <svg width={width}   viewBox="0 0 20 20" ref={IconRef} onMouseEnter={handleEnter} onMouseLeave={handleLeave} onClick={onClick} className={className}>
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M12.1158 5.97998L13.0309 7.77212L15.018 8.08773L13.5956 9.5114L13.9097 11.4987L12.1158 10.5863L10.3217 11.4987L10.6359 9.5114L9.21338 8.08773L11.2006 7.77212L12.1158 5.97998Z" fill="var(--Copy)"/>
        </svg>
