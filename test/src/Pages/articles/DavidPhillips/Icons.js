    ...
    return(
        <ArticalContainer properties={properties}>
            <div>
                ...
                <IMG className={'inline'}src={require('../../../images/articles/davidphillips/oldiconsissue.png')}alt='an open spread in a brochure showing inconsistant icons'/>
            ...
            <div>
                ...
                <IMG className={'inline'} src={require('../../../images/articles/davidphillips/waredrobesspread.png')}alt='an open spread in a brochure demonstraiting the use of the new icons'/>
