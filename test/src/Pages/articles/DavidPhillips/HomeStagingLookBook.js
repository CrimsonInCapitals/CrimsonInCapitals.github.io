...
const properties = new PageClass('Home Staging Look Book','/articles/davidphillips/homestaginglookbook',4,'06/21/2025','article',{chips:[DavidPhillips,InDesign,PrintDesign,Adobe,Illustrator]})
...
const Page = ()=>{
    ...
    return(
        <ArticalContainer properties={properties}>
            <IMG className='inline'src={require('../../../images/articles/davidphillips/homestaginglookbook/coverm.webp')} alt='a mochup of the front of the brochure'/>
