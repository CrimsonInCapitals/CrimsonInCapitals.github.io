...
import { Adobe, Brand, Canva, DavidPhillips, Designer, Figma, IconD, MSOffice, Presentations, ProcessOpt, Reactchip } from "../../../components/Chips"
...
const properties = new PageClass('David Phillips Brand Refresh','/articles/davidphillips/brandrefresh',3,'09/14/2024','article',{chips:[<DavidPhillips/>,<Brand/>,<Reactchip/>,<IconD/>,<Figma/>,<Designer/>,<Canva/>,<Adobe/>,<MSOffice/>]})
    ...
    return(
        <ArticalContainer properties={properties}>
            ...
            <div>
                ...
                {/* <IMG src={require('../../images/articles/davidphillips/Templateslides/1.png')}/>            */}
                <span>
