    ...
    return(
        <ArticalContainer properties={properties}>
            ...
            <div className="bff">
                ...
                Here is what this looks like in practice.</p>
            </div>
            ...
            <div className="bff">
                ...
                <p>I explored how the feather might be used in isolation, as well as how it might be integrated into other forms</p>
            </div>
            ...
            <div className="bff">
                ...
                <p>Aspinal of London has a set of beehives on the property of its corporate office and sells the honey produced in small batches; this is part of their effort to promote sustainable practices and help the wildflowers that grow around the local ponds. We discussed how this could be used as a symbol.</p> 
            </div>
            ...
            <div className="bff">
                ...
                <p>I explored how the letter ‘A’ could be used in different contexts. The Aspinal name being common to both brands means this mark could be used by both, or by an Umbrell brand. I also explored integrating the ‘A’ into patterns, as seen with other luxury brands.</p>
            </div>
            ...
            <div className="bff">
                <h4>A Roundel</h4>
                <p>A circular heraldic device, also found on the logo of the London Underground. The historic significance of the roundel within heraldry, as well as British culture fits in perfectly with the other selected symbols. I experimented with ways in which the logo type could be integrated into a spherical design, such as on buttons or jewellery.</p>
            </div>
            ...
            <p>As you can see I tried a number of different styles, incorporating other elements of the brand.</p>
