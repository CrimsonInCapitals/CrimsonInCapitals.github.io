...
const Page = ()=>{
    return(
        <ArticalContainer properties={properties}>
                ...
                <span className="row3">
                    <IMG className="inline" src={require('../../images/articles/bobbinandem/internalboxmockup.png')} alt='a set of 8 icons of different styles of underware'/>
                    <IMG className="inline" src={require('../../images/articles/bobbinandem/externalboxmockup.png')} alt='incons depicting how to take messurments for bra sizing'/>         
                    <IMG className="inline" src={require('../../images/articles/bobbinandem/stickerreel.png')} alt='incons depicting how to take messurments for bra sizing'/>         
