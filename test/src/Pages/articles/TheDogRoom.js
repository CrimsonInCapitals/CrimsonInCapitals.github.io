...
const Page = ()=>{
    return(
        <ArticalContainer properties={properties}>
            ...
            <IMG className={'inline'}src={require('../../images/articles/thedogroom/fonts.png')}/>
                <IMG className={'inline'}src={require('../../images/articles/thedogroom/colours.png')}alt="the dog room colour palette, consisting of yellow, 3 accent shades, red, green, and blue as secondary colours"/>
                ...
                <IMG className={'inline'}src={require('../../images/articles/thedogroom/logos.png')}alt="the dog room wrtien in a fun font in a bright yellow"/>
            ...
            <IMG className={'inline'}src={require('../../images/articles/thedogroom/premadeposts.png')} alt="4 examples of premade social media posts"/>
            ...
            <IMG className={'inline'}src={require('../../images/articles/thedogroom/instagram page.png')} alt="a screenshot of the dog room instagram account"/>
...
const Bento = ()=>{
    return(
        <Link to='../articles/thedogroom' className="QuickBento Dogroombento"></Link>
    )
}
