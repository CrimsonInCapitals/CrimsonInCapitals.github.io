...
properties.image = URL(backgroundImage)
...
const Page = ()=>{
    return(
        <ArticalContainer properties={properties}>
                ...
                <p>
                    TThe beautiful florals are from  <a target="_blank" style={{textDecoration:'underline',color:'var(--Crimson)',fontStyle:'italic'}}href="https://unsplash.com/@rikonavt" >Rikonavt</a> on Unsplash.
                </p>
                <p>
