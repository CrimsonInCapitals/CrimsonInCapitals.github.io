    ...
    return(
        <ArticalContainer properties={properties}>
            <div className="bff">
                ...
                <p>
                   For this example, I have created a mock-up template using a beautiful image from <a target="_blank" className="inlinelink"href="https://www.instagram.com/ebahiir" >ebahiir</a> of three pieces of artwork running up a flight of stairs. On the mock-up, you will see small labels that correspond to the names of the artboards on the left. These are only visible in the file and won’t be on the final export.
                </p>
                ...
                <IMG className="inline" src={require('../../../images/articles/afhowto/Mockup Examples.webp')} alt='final export of mockup with three peaces of artwork'/>
                <div className="bff">
                <p>
                    From there, select the mock-up and export.
                </p>
                <p>
                    The beautiful florals are from  <a target="_blank" className="inlinelink"href="https://unsplash.com/@rikonavt" >Rikonavt</a> on Unsplash.
                </p>
                <p>
