...
import { Brand, Designer, Figma, IconD, Presentations } from "../../components/Chips"
...
const properties = new PageClass('Overbury Co-branded Deck','/articles/overbury',4,'09/06/2025','article',{chips:[<Brand/>,<Presentations/>,<Figma/>]})
