...
import { Adobe, AfterEffects, AnimationChip, Brand, Designer, Figma, IconD, Motion, Presentations } from "../../components/Chips"
...
const properties = new PageClass('Scottish Widows: Brand Mark Animation','/articles/scottishwidows',4,'09/03/2025','article',{chips:[<Brand/>,<Motion/>,<AfterEffects/>,<AnimationChip/>,<Adobe/>]})
