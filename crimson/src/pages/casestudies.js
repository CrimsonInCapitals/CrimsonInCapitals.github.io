...
const CaseStudies = ()=> {
    ...
    return (
        <main className='home'>
            <section id='cardDeck'>
                <CaseText size='exwide' Header='Case Studies'>Since 2019 I have had the great privilege to work with some fantastic people and businesses to create personal and meaningful content for a variety of mediums. I have collated several projects I have worked on for your exploration.</CaseText>
